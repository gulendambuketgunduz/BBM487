...
namespace WindowsFormsApplication1
{
    public partial class LoginForm : Form
    {
        ...
        private void LoginButton_Click(object sender, EventArgs e)
        {
            ...
            string _userkontrol = "Select * from tblUser where UserName='" + tbxUserName.Text + "' And UserPassword='" + tbxPassword.Text + "' And UserStatus=1";/*if UserStatus=1,member active*/
            ...
            if (_dt != null && _dt.Rows.Count > 0)
            {
                ...
                if (_dt.Rows[0]["UserType"].ToString() == "0")/*If the user is a member,it is UserType=0 in database*/
                {
                    ...
                    form.lblUserName.Text = UserInfo.Name+" "+UserInfo.SurName + " WELLCOME!";
        ...
        private void btnSignup_Click(object sender, EventArgs e)
        {
            ...
            signForm.Show();/*Go to the Sign up button*/
        }
